    ...
    facilities=(
        SiteFacility(
            ...
            it_load_citation=(
                ...
                f"ft yields {_BOWLING_GREEN_FLOOR.high:g} MW, independently bracketing the disclosed "
                "~180 MW peak at its top (corroboration, not a second source). The campus is "
