...
The per-stream :func:`watermark.hydrology.assimilative.check_assimilative` reads each WWTP
...
discharges from the :class:`~watermark.hydrology.model.WaterBalance`, and the scenario's
