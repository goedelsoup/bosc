...
Mirrors :func:`watermark.pipeline.analyze.reconcile`'s shape: a single deterministic
...
from watermark.hydrology import supply as supply_stage
...
def compare_theory(
    ...
    *,
    ...
    quantified :func:`~watermark.hydrology.network.theory_findings` (the directed inflow it
