...
def cooling_reconcile_cmd(
    ...
    console.print(
        ...
        r"reservation-conflict (Troy-Piqua B1, #1681; Bowling Green B5, #1685) is a low-water claim "
        r"contradicted by a reserved CEILING (the 'reserved' documented cell) — not a discharge/"
        r"withdrawal instrument, so it KEEPS whatever the profile pins (Troy-Piqua's UNKNOWN, Bowling "
        r"Green's closed_loop_dry) and sharpens that site's water lead (#1486, #1439), never a "
        r"headline consumptive. It also survives a blind route: a negotiated ceiling is not something "
        r"the withdrawal/discharge instruments could have metered, so blinding them cannot erase it — "
        r"which is why Bowling Green reads reservation-conflict and not route-blind. A 'disclosed' "
