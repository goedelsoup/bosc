...
class DocumentEntry:
    ...
    # Version / duplicate-cluster metadata (#1590), stamped by watermark.site.docversions from the
    # curated custody manifest after the catalog is built. All default-None for an unclustered file.
    ...
    for c in result.collections:
        entries = [
            DocumentItem(
                ...
                duplicate_cluster=e.duplicate_cluster,
                canonical_document_id=e.canonical_document_id,
                version=e.version,
