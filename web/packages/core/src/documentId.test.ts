...
describe("documentId — the corpus it has to address", () => {
  it("mints a distinct handle for all 3,247 committed Lima rels", () => {
    const rels = limaRels();
    expect(rels.length).toBe(3247); // a corpus change should surface here, not as a silent collision
