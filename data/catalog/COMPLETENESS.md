...
Snapshot reconciled: **2026-07-24T13:25:27.047145+00:00**. Regenerate with `watermark catalog audit --apply` after `watermark catalog reconcile`.

## Headline

- **123** catalogued datasets — **122** reviewed.
- **123** present and fresh · **0** stale · **0** LFS pointer (not materialized in this checkout).
