...
Snapshot reconciled: **2026-07-03T17:44:09.841264+00:00**. Regenerate with `watermark catalog audit --apply` after `watermark catalog reconcile`.

## Headline

- **98** catalogued datasets — **97** reviewed.
- **98** present and fresh · **0** stale · **0** LFS pointer (not materialized in this checkout).
