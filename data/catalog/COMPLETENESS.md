...
Snapshot reconciled: **2026-07-27T15:05:06.542271+00:00**. Regenerate with `watermark catalog audit --apply` after `watermark catalog reconcile`.

## Headline

- **127** catalogued datasets — **126** reviewed.
- **127** present and fresh · **0** stale · **0** LFS pointer (not materialized in this checkout).
