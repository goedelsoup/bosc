...
Snapshot reconciled: **2026-09-05T03:30:01.505015+00:00**. Regenerate with `watermark catalog audit --apply` after `watermark catalog reconcile`.

## Headline

- **203** catalogued datasets — **202** reviewed.
- **203** present and fresh · **0** stale · **0** LFS pointer (not materialized in this checkout).
