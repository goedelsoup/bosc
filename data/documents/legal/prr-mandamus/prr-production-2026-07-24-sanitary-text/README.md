# prr-production-2026-07-24-sanitary-text

**Derived text sidecars — not source evidence.**

Plain-text transcriptions of the legacy binary documents (`.doc` / `.dot` / `.xls` / `.rtf`) in
the sibling [`prr-production-2026-07-24-sanitary/`](../prr-production-2026-07-24-sanitary/), which have no in-process text reader and were
...
```sh
watermark text-sidecars legal/prr-mandamus/prr-production-2026-07-24-sanitary          # rewrite this tree
watermark text-sidecars legal/prr-mandamus/prr-production-2026-07-24-sanitary --check  # verify it still matches the source bytes
```
