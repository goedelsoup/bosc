# West Union · Adams Co (west-union) — RSEI toxics outputs
...
`bosc onboard west-union` over the West Union · Adams Co `SiteProfile` — EPA RSEI (county toxics release inventory).
