...
`bosc onboard west-union` over the West Union · Adams Co `SiteProfile` — per-site authored reference inputs + per-jurisdiction connectors (site geometry, parcels/zoning).
