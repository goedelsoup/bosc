# Bowling Green · Middleton Twp (bowling-green) — economics baseline outputs
...
`watermark onboard bowling-green` over the Bowling Green · Middleton Twp `SiteProfile` — US Census · BLS QCEW (county economic baseline).
