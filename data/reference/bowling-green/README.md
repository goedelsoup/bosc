...
### `bowling-green-watch-items` — Bowling Green site watch-items (WWTP infrastructure geometry)

Source: Derived from Ohio EPA "Fact Sheet for NPDES Permit" 2PD00009*TD (City of Bowling Green Water Pollution Control, application OH0024139) and the permit itself, as transcribed in data/extracted/oepa/bowling-green/2PD00009.fs.npdes.yaml and 2PD00009.npdes.yaml (#1439); facility coordinates (41.385022, -83.611078) from the EPA ECHO Portage-basin inventory data/reference/echo/portage-wwtp.potw.yaml (#1433) · License: Public record (Ohio R.C. 149.43 / U.S. Government work) · Access: public · Site scope: site:bowling-green · Refresh: static

| file | type | lfs |
| --- | --- | --- |
| `reference/bowling-green/watch-items.geojson` | application/geo+json | no |
