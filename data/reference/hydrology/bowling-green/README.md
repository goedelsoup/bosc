# Bowling Green · Middleton Twp (bowling-green) — hydrology connector outputs
...
`watermark onboard bowling-green` over the Bowling Green · Middleton Twp `SiteProfile` — USGS NWIS (7Q10) · NOAA Atlas-14 (corridor DDF) · USDA NRCS SSURGO (dominant HSG) · NASA-POWER (climatology).
