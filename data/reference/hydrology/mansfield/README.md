# Mansfield (mansfield) — hydrology connector outputs
...
`watermark onboard mansfield` over the Mansfield `SiteProfile` — USGS NWIS (7Q10) · NOAA Atlas-14 (corridor DDF) · USDA NRCS SSURGO (dominant HSG) · NASA-POWER (climatology).
