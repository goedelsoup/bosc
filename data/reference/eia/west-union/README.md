# West Union · Adams Co (west-union) — energy / grid outputs
...
`bosc onboard west-union` over the West Union · Adams Co `SiteProfile` — EIA-861 (utility retail) · EIA-930 (RTO demand/mix) · EIA v2 API (consumer energy prices).
