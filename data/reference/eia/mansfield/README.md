# Mansfield (mansfield) — energy / grid outputs
...
`watermark onboard mansfield` over the Mansfield `SiteProfile` — EIA-861 (utility retail) · EIA-930 (RTO demand/mix) · EIA v2 API (consumer energy prices).
