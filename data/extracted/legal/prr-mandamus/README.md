...
| [`bosc-prr-production-2026-07-24.response-index.yaml`](bosc-prr-production-2026-07-24.response-index.yaml) · [`bosc-prr-production-2026-07-24.analysis.md`](bosc-prr-production-2026-07-24.analysis.md) · [`bosc-prr-production-2026-07-24.custody-manifest.yaml`](bosc-prr-production-2026-07-24.custody-manifest.yaml) | **Allen County Sanitary Engineer** batch 3 — the per-item native file trees (items 9/11/13/14/15), 1,610 files off a USB drive; the first production with a byte-level custody manifest. |
| [`bosc-prr-production-2026-08-lima.response-index.yaml`](bosc-prr-production-2026-08-lima.response-index.yaml) · [`bosc-prr-production-2026-08-lima.analysis.md`](bosc-prr-production-2026-08-lima.analysis.md) · [`bosc-prr-production-2026-08-lima.custody-manifest.yaml`](bosc-prr-production-2026-08-lima.custody-manifest.yaml) | **City of Lima** batches 1–2 (2026-08-22 / 2026-08-24) — the first municipal-utility production (#1536). Answers 4 of 11 items; 7 drew nothing and no exemption was asserted. Carries the corpus's first primary LAB record (ammonia benchsheets) and the WWTP's CSO/SSO outfall inventory. Extractions in [`prr-production-2026-08-lima/`](prr-production-2026-08-lima/). |
