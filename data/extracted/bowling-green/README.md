# Bowling Green · Middleton Twp (bowling-green) — extractions
...
`watermark onboard bowling-green` over the Bowling Green · Middleton Twp `SiteProfile` — the ingest→extract corpus pipeline over this site's source documents.
