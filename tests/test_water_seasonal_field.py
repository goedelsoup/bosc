...
def test_contract_version_bumped() -> None:
    """This feed landed at 1.22.0 (additive/MINOR); the contract has since advanced to 1.34.0
    ...
    acute (1Q10) dilution pair 1.34.0 (WS-08 #1608))."""
    assert CONTRACT_VERSION == "1.34.0"
