...
def test_contract_version_bumped() -> None:
    """This feed landed at 1.22.0 (additive/MINOR); the contract has since advanced to 1.30.3
    ...
    the effluent-credited dilution ratio 1.30.2 #1615, then the routed-hydrograph reach
    subreaches/courant 1.30.3 (WS-09 #1609))."""
    assert CONTRACT_VERSION == "1.30.3"
