...
def test_contract_version_bumped() -> None:
    """This feed landed at 1.22.0 (additive/MINOR); the contract has since advanced to 1.35.0
    ...
    1.34.0 (#1746), then the grid-backdrop feed 1.35.0 (GP-E #1642))."""
    assert CONTRACT_VERSION == "1.35.0"
