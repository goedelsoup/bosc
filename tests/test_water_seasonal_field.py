...
def test_contract_version_bumped() -> None:
    """This feed landed at 1.22.0 (additive/MINOR); the contract has since advanced to 1.24.0
    (the ProvenancedValue range at 1.23.0 #760, then the contacts feed at 1.24.0)."""
    assert CONTRACT_VERSION == "1.24.0"
